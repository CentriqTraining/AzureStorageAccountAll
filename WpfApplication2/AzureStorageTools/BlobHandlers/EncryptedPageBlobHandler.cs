...
{
    public class EncryptedPageBlobHandler : BlobHandler<CloudPageBlob>
    {
        private BlobRequestOptions _BlobUploadEncryptionOptions;
        private BlobRequestOptions _BlobDownloadEncryptionOptions;
